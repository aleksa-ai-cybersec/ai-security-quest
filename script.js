    ...
    1: {
        ...
        options: [
            ...
            { id: 2, text: "🌐 Из открытых источников", isCorrect: false,
              ...
              threat: threats.t2, effects: { budget: -10, security: -20, time: 10 } }, // time: 25 → 10
            ...
            { id: 3, text: "👥 Нанять фрилансеров ($20K)", isCorrect: false,
              ...
              threat: threats.t3, effects: { budget: -10, security: -15, time: 5 } }, // time: 10 → 5
            ...
            { id: 4, text: "🤖 Синтетические данные ($100K)", isCorrect: false,
              ...
              threat: null, effects: { budget: -35, security: 10, time: 10 } } // time: 25 → 10
        ]
    },
    2: {
        ...
        options: [
            ...
            { id: 2, text: "🟢 Google Cloud (скидка, $75K)", isCorrect: false,
              ...
              threat: threats.t4, effects: { budget: -15, security: -20, time: 5 } }, // time: 0 → 5
            ...
            { id: 3, text: "🏢 Свои сервера ($25K)", isCorrect: false,
              ...
              threat: threats.t5, effects: { budget: -5, security: -35, time: 15 } }, // time: 40 → 15
    ...
    3: {
        ...
        options: [
            { id: 1, text: "🔍 Отложить релиз, провести полное тестирование", isCorrect: false,
              ...
              threat: null, effects: { budget: -15, security: 15, time: 10 } }, // time: 15 → 10
            ...
            { id: 2, text: "🚀 Выпустить сейчас, фиксить потом", isCorrect: false,
              ...
              threat: threats.t6, effects: { budget: -10, security: -25, time: 0 } }, // time: 5 → 0
            ...
            { id: 3, text: "⚖️ Проверить только критичные сценарии", isCorrect: false,
              ...
              threat: threats.t7, effects: { budget: -5, security: -10, time: 0 } }, // time: 5 → 0
            ...
            { id: 4, text: "🔬 Нанять внешних аудиторов ($50K)", isCorrect: true,
              ...
              threat: null, effects: { budget: -25, security: 30, time: 10 } } // time: 20 → 10
        ]
    },
    4: {
        ...
        options: [
            ...
            { id: 2, text: "📊 Мониторинг и анализ паттернов", isCorrect: true,
              ...
              threat: null, effects: { budget: -20, security: 25, time: 5 } }, // time: 10 → 5
            ...
            { id: 3, text: "🔄 Полностью переделать API", isCorrect: false,
              ...
              threat: null, effects: { budget: -40, security: 50, time: 15 } }, // time: 30 → 15
    ...
    5: {
        ...
        options: [
            { id: 1, text: "🛑 Думаем это DDoS, ставим защиту", isCorrect: false,
              ...
              threat: threats.t10, effects: { budget: -10, security: -20, time: 5 } }, // time: 0 → 5
            ...
            { id: 2, text: "🔎 Анализировать вручную", isCorrect: false,
              ...
              threat: threats.t11, effects: { budget: -15, security: 30, time: 20 } }, // time: 40 → 20
            ...
            { id: 3, text: "⛔ Отключить API на неделю", isCorrect: false,
              ...
              threat: null, effects: { budget: -30, security: 40, time: 10 } }, // time: 20 → 10
            ...
            { id: 4, text: "🤖 Использовать Интеллектуальный аудитор", isCorrect: true,
              ...
              threat: null, effects: { budget: 0, security: 50, time: -10 } } // time: -20 → -10
        ]
    },
    6: {
        ...
        options: [
            { id: 1, text: "🔄 Полностью автоматически", isCorrect: false,
              ...
              threat: threats.t12, effects: { budget: -5, security: -30, time: 5 } }, // time: 10 → 5
            ...
            { id: 2, text: "👨‍💻 Ручное с проверкой", isCorrect: true,
              ...
              threat: null, effects: { budget: -10, security: 20, time: 15 } }, // time: 30 → 15
            ...
            { id: 3, text: "🤖 Полуавтоматическое", isCorrect: false,
              ...
              threat: threats.t13, effects: { budget: -15, security: -40, time: 5 } }, // time: 15 → 5
            ...
            { id: 4, text: "⏸️ Отложить", isCorrect: false,
              ...
              threat: null, effects: { budget: -20, security: -10, time: 10 } } // time: 20 → 10
        ]
    }
};
